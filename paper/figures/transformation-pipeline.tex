\begin{tikzpicture}[
  ...
  \node[branch, below=6mm of derivation] (derived) {Derived\\assurance};
  \node[branch, below right=6mm and 28mm of derivation] (technical) {Technical\\control};
  ...
  \node[wide, below=of machine] (final) {Reviewed final status};
